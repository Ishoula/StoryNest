    ...
    <section class="features" id="features">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <p>Never lose your page again. Our auto-save technology remembers your scroll position down to the exact paragraph.</p>
            </div>
            <div class="feature-card">
                <h3>Advanced Filtering</h3>
                <p>Find your next read by genre, author, or even reading time. Perfect for finding a story that fits your schedule.</p>
            </div>
            <div class="feature-card">
                <h3>Personal Library</h3>
                <p>Organize your collection, save favorites, and see your reading stats improve over time.</p>
            </div>
        </div>
    </section>

    <footer>
        <p>&copy; 2026 StoryNest. Designed for those who live a thousand lives before they die.</p>
    </footer>
